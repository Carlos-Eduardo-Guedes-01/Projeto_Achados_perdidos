...
<html lang="pt-br">
<head>
  <title>Objetos Devolvidos - Admin</title>
  <meta charset="UTF-8">
...
#========================================================================================================
$sql_query_lista=$conexao->query("SELECT i.img,u.nome_usuario,i.id,i.nome,i.descricao,ut.situacao FROM usuario_item ut,usuario u,item i where ut.situacao='Devolvido' and u.id=ut.id_usuario and i.id=ut.id_item order by u.nome_usuario;");
...
?>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <h6 class="card-subtitle mb-2 font-weight-bold">Devolvido para <p><?php echo $l['nome_usuario']?></p></h6>
    </div>
    <div class="card-footer">
      <small class="text-muted">Situação: <p style="color: #008000"><?php echo $l['situacao']?></p></small>
    </div>
  </div>
  </div>
